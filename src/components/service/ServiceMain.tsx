...
function ServiceMain(){
    return (
        <>
            ...
            <ServiceContent img={"./photo/gcc-launcher-electron-2024.png"} title={"GCC launcher-electron"} language={"Typescript"} url="https://github.com/kisia0916/gcc-launcher-electron-2024"/>
            <ServiceContent img={"./photo/regic-setup-guide.png"} title={"Regic-setupguide"} language={"Typescript"} url="https://github.com/kisia0916/regic-setup-guide"/>
